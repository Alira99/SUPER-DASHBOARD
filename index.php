...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="app-brand demo">
          <a href="index.php" class="app-brand-link">
            <span class="app-brand-logo demo">
              <img src="plugins/assets/img/avatars/buds-logo.png" alt="" class="brand-image" width="20" height="20">
            </span>
            <span class="text-uppercase text-white app-brand-text demo menu-text fw-bolder ms-2">Buds | Admin Panel</span>
          </a>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-xl-center">
    ...
    <div class="col-md-6 col-lg-6 p-1">
      <div class="card card-primary">
        <div class="card-body text-center">
          ...
          <div class="card-body">
            <div class="chart">
              <canvas id="pieChart" style="height: 300px; max-width: 100%;"></canvas>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex"><div class="col-sm-2">
        <div class="form-floating p-1">
            ...
            <label for="floatingSelect1">Select 1</label>
        </div>
        <div class="form-floating p-1">
            <select class="form-select" id="floatingSelect1" aria-label="Floating label select example">
                <option selected>Open this select menu</option>
